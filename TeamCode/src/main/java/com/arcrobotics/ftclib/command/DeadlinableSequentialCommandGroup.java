...
public class DeadlinableSequentialCommandGroup extends CommandGroupBase {
     ...
     */
    public DeadlinableSequentialCommandGroup(Command... commands) {
    ...
    public void end(boolean interrupted) {
        ...
        // this is the one evil line that prevented a regular SequentialCommandGroup from being used as a deadline in ParallelDeadlineGroup.
